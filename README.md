...
Welcome to the **Yael is Getting Married** repository! This project is dedicated to celebrating Maly's wedding with a unique and interactive software application. Whether you're here as a guest or a contributor, we're excited to share this project with you.
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/ruth7873/Yael-is-getting-married
   ```
2. **Open the Project:**
